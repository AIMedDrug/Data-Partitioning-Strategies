...
# ================== 路径配置 ==================
base_dir = "/home/bioinfor6/BGM/fenziduiqi/ESMC"
input_csv = os.path.join(base_dir, "embed_list.csv")     # 第一列=PDB，第二列=Mutation，X1/X2 空
wild_dir  = os.path.join(base_dir, "ESMC_Wild_result")   # 野生型 .pt 所在目录
mut_dir   = os.path.join(base_dir, "ESMC_Mut_result")    # 突变体 .pt 所在目录
output_csv = os.path.join(base_dir, "ESMC_embed_list.csv")
