...
output_dir = '/home/data1/BGM/fenziduiqi/All_X-_UNIPORT_4179_BiLSTM_best_result'
...
for idx in range(30):
    ...
    # 保存预测图
    figname = f'BiLSTM_prediction_run{idx+1}.png'
    output_path = os.path.join(output_dir, figname)
    plt.savefig(output_path, dpi=900)
    plt.close()
    
    # 保存预测结果
    prediction_file = f'BiLSTM_prediction_run{idx+1}.csv'
...
results_df.to_csv(os.path.join(output_dir, 'BiLSTM_UNIPORT_best_results.csv'), index=False)