...
output_dir = '/home/data1/BGM/fenziduiqi/All_X-_4179_Transformer_Q13315_UNIPROT_result'
...
class TransformerRegressor(nn.Module):
    def __init__(self, input_dim, hidden_dim=128, num_layers=2, dropout=0.2, nhead=8):
    ...
    for idx in range(30):
        ...
        for epoch in range(num_epochs):
            ...
            for batch_X, batch_y in train_loader:
                ...
                loss = criterion(outputs, batch_y)  # 修正为直接使用 batch_y
                loss.backward()
                optimizer.step()
