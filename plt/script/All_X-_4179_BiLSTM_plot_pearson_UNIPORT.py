...
# Load CSV file
csv_file = '/home/data1/BGM/fenziduiqi/All_X-_UNIPORT_4179_BiLSTM_result/BiLSTM_UNIPORT_results.csv'
...
plt.ylim(-0.05, 0.4)
plt.yticks([0, 0.1, 0.2, 0.3, 0.4], fontsize=48)
...
# Save the plot
plt.savefig('/home/data1/BGM/fenziduiqi/All_X-_4179_BiLSTM_plot_pearson_UNIPORT.png', dpi=900)
plt.close()