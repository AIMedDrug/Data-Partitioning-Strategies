...
# Load CSV file
csv_file = '/home/data1/BGM/fenziduiqi/All_X-_DNN_4179_result/DNN_results.csv'
...
plt.title('Pearson by HD and Dt of DNN', fontsize=50)
...
plt.xlabel('Hidden Dim', fontsize=50)
plt.ylabel('Pearson', fontsize=50)
plt.title('Pearson by HD and NL of DNN', fontsize=50)
plt.tick_params(axis='both', labelsize=48)
plt.ylim(-0.1, 0.8)
plt.yticks([0, 0.2, 0.4, 0.6, 0.8], fontsize=48)
...
# Save the plot
plt.savefig('/home/data1/BGM/fenziduiqi/All_X-_4179_DNN_plot_pearson_random.png', dpi=900)
plt.close()