...
# Load CSV file
csv_file = '/home/data1/BGM/fenziduiqi/All_X-_GRU_4179_result/GRU_results.csv'
...
y_positions = [0.74, 0.68, 0.68, 0.62, 0.62]
...
plt.figtext(0.8, 0.74, 'Dropout', ha='center', va='center', fontsize=40)
...
# Save the plot
plt.savefig('/home/data1/BGM/fenziduiqi/All_X-_4179_GRU_plot_pearson_random.png', dpi=900)
plt.close()