...
# 1. 读入数据
excel_path = "/home/data1/BGM/fenziduiqi/拼接和差值all_model_best_random_pearson.xlsx"
save_path = "/home/data1/BGM/fenziduiqi/All_esm_X-_model_plot_random_box.png"
...
plt.title('Con VS Dif - random', fontsize=50)
plt.tick_params(axis='both', labelsize=48)
plt.ylim(0.2, 0.8)
plt.yticks([0.3, 0.4, 0.5, 0.6, 0.7, 0.8], fontsize=48)
