...
# Load CSV file
csv_file = '/home/data1/BGM/fenziduiqi/All_X-_BiLSTM_4179_result/BiLSTM_results.csv'
...
x_positions = [0.34, 0.23, 0.34, 0.23, 0.34]
y_positions = [0.73, 0.67, 0.67, 0.61, 0.61]
...
plt.figtext(0.22, 0.73, 'Dropout', ha='center', va='center', fontsize=40)

plt.xlabel('Hidden Dim', fontsize=50)
plt.ylabel('Pearson', fontsize=50)
plt.title('Pearson by HD and Dt of BiLSTM', fontsize=50)
...
plt.xlabel('Hidden Dim', fontsize=50)
plt.ylabel('Pearson', fontsize=50)
plt.title('Pearson by HD and NL of BiLSTM', fontsize=50)
plt.tick_params(axis='both', labelsize=48)
plt.ylim(-0.05, 0.8)
plt.yticks([0, 0.2, 0.4, 0.6, 0.8], fontsize=48)
...
# Save the plot
plt.savefig('/home/data1/BGM/fenziduiqi/All_X-_4179_BiLSTM_plot_pearson_random.png', dpi=900)
plt.close()