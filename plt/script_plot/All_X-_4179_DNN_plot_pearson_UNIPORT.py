...
# Load CSV file
csv_file = '/home/data1/BGM/fenziduiqi/All_X-_UNIPORT_4179_DNN_result/DNN_UNIPORT_results.csv'
...
# Save the plot
plt.savefig('/home/data1/BGM/fenziduiqi/All_X-_4179_DNN_plot_pearson_UNIPORT.png', dpi=900)
plt.close()