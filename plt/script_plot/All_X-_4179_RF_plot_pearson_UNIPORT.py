...
# Load CSV file
csv_file = '/home/data1/BGM/fenziduiqi/All_X-_UNIPORT_4179_RF_result/RF_UNIPORT_results.csv'
...
plt.ylim(0.1, 0.18)
plt.yticks([0.1, 0.12, 0.14, 0.16, 0.18], fontsize=48)
...
# Save the plot
plt.savefig('/home/data1/BGM/fenziduiqi/All_X-_4179_RF_plot_pearson_UNIPORT.png', dpi=900)
plt.close()