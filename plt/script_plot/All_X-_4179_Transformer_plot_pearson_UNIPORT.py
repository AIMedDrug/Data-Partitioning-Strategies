...
# Load CSV file
csv_file = '/home/data1/BGM/fenziduiqi/All_X-_UNIPORT_4179_Transformer_result/Transformer_UNIPORT_results.csv'
...
y_positions = [0.73, 0.68, 0.68, 0.63, 0.63]
...
plt.figtext(0.8, 0.73, 'Dropout', ha='center', va='center', fontsize=40)
...
plt.ylim(-0.6, 0.4)
plt.yticks([-0.6, -0.4, -0.2, 0, 0.2, 0.4], fontsize=48)
...
# Save the plot
plt.savefig('/home/data1/BGM/fenziduiqi/All_X-_4179_Transformer_plot_pearson_UNIPORT.png', dpi=900)
plt.close()