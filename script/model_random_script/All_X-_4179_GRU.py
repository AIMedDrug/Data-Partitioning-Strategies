...
output_dir = '/home/data1/BGM/fenziduiqi/All_X-_GRU_4179_result'
    ...
    for hidden_dim in hidden_dim_list:
        for dropout in dropout_list:
            for num_layers in num_layers_list:
                ...
                plt.title('True vs Predicted DDG - GRU', fontsize=8)
...
results_df.to_csv(os.path.join(output_dir, 'GRU_results.csv'), index=False)