...
output_dir = '/home/data1/BGM/fenziduiqi/All_X-_4179_Transformer_Q13315_random_result'
...
for ratio in ratios:
    for idx in range(30):
        ...
        # 使用 GPU
        device = torch.device("cuda:1" if torch.cuda.is_available() else "cpu")  # 修正为 cuda:0
